...
class GroupsApi {
  ...
  Future<Response<void>> createGroupApiV1GroupsPost({
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetGroupDetailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetGroupDetailResponse>> getGroupDetailApiV1GroupsGroupIdGet({
    ...
    GetGroupDetailResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetGroupDetailResponse),
            ) as GetGroupDetailResponse;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<GetGroupDetailResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetGroupMembersResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetGroupMembersResponse>>
    ...
    final _path = r'/api/v1/groups/{group_id}/members'.replaceAll(
        '{' r'group_id' '}',
        encodeQueryParameter(_serializers, groupId, const FullType(int))
            .toString());
    final _options = Options(
    ...
    GetGroupMembersResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetGroupMembersResponse),
    ...
    return Response<GetGroupMembersResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> joinGroupApiV1GroupsGroupIdJoinPatch({
    required int groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/groups/{group_id}/join'.replaceAll(
        '{' r'group_id' '}',
        encodeQueryParameter(_serializers, groupId, const FullType(int))
            .toString());
    final _options = Options(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetGroupsResponse>> listingGroupApiV1GroupsGet({
    String? name,
    String? isMember,
    String? sortBy,
    CancelToken? cancelToken,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'is_member':
          encodeQueryParameter(_serializers, isMember, const FullType(String)),
      r'sort_by':
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListingTopGroupResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListingTopGroupResponse>>
    ...
    final _path = r'/api/v1/groups/top-groups';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ListingTopGroupResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ListingTopGroupResponse),
            ) as ListingTopGroupResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ListingTopGroupResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
