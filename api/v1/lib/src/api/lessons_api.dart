...
class LessonsApi {
  ...
  Future<Response<void>> createLessonApiV1LessonsPost({
    ...
    try {
      const _type = FullType(CreatePersonLessonRequest);
      _bodyData = _serializers.serialize(createPersonLessonRequest,
          specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetLessonDetailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetLessonDetailResponse>>
    ...
    GetLessonDetailResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetLessonDetailResponse),
            ) as GetLessonDetailResponse;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<GetLessonDetailResponse>(
      data: _responseData,
  ...
  Future<Response<LearnLessonResponse>>
    ...
    final _path = r'/api/v1/lessons/{lesson_id}/learn'.replaceAll(
        '{' r'lesson_id' '}',
        encodeQueryParameter(_serializers, lessonId, const FullType(int))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> likeLessonApiV1LessonsLessonIdLikePatch({
    required int lessonId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/lessons/{lesson_id}/like'.replaceAll(
        '{' r'lesson_id' '}',
        encodeQueryParameter(_serializers, lessonId, const FullType(int))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListLessonsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListLessonsResponse>> listingLessonsApiV1LessonsGet({
    bool? isPublic,
    String? userOwnerId,
    String? groupOwnerId,
    String? keyword,
    ...
    final _queryParameters = <String, dynamic>{
      r'is_public':
          encodeQueryParameter(_serializers, isPublic, const FullType(bool)),
      r'user_owner_id': encodeQueryParameter(
          _serializers, userOwnerId, const FullType(String)),
      r'group_owner_id': encodeQueryParameter(
          _serializers, groupOwnerId, const FullType(String)),
      r'keyword':
    ...
    ListLessonsResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ListLessonsResponse),
            ) as ListLessonsResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ListLessonsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RecommendLessonResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RecommendLessonResponse>>
    ...
    final _path = r'/api/v1/lessons/recommend';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RecommendLessonResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(RecommendLessonResponse),
            ) as RecommendLessonResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<RecommendLessonResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> unlikeLessonApiV1LessonsLessonIdUnlikePatch({
    required int lessonId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/lessons/{lesson_id}/unlike'.replaceAll(
        '{' r'lesson_id' '}',
        encodeQueryParameter(_serializers, lessonId, const FullType(int))
            .toString());
    final _options = Options(
