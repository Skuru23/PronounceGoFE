...
class WordsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CheckPronounceResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CheckPronounceResponse>> checkPronounceApiV1WordsCheckPost({
    required CheckPronounceRequest checkPronounceRequest,
    ...
    final _path = r'/api/v1/words/check';
    ...
    try {
      const _type = FullType(CheckPronounceRequest);
      _bodyData =
          _serializers.serialize(checkPronounceRequest, specifiedType: _type);
    ...
    CheckPronounceResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CheckPronounceResponse),
            ) as CheckPronounceResponse;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<CheckPronounceResponse>(
      data: _responseData,
