...
Serializers _$serializers = (new Serializers().toBuilder()
      ..add(CheckPronounceRequest.serializer)
      ..add(CheckPronounceResponse.serializer)
      ..add(CreateGroupRequest.serializer)
      ..add(CreatePersonLessonRequest.serializer)
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<WordBase>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(LessonSentenceBase)]),
          () => new ListBuilder<LessonSentenceBase>())
      ..addBuilderFactory(
